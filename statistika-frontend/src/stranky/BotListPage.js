  ...
  return (
    <div className="bot-list-main-div">
      ...
      <ul className="list-burza">
        {loading && <LoadingComponent background={false} height={height - 300} loadingText={loadingMessage}></LoadingComponent>}
        {pageData.map((burza, i) => {
          return (
            <li style={{ opacity: loading ? 0 : 100 }} key={i} className="li-burza">
